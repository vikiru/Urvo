/*! For license information please see main.feb95e2d.js.LICENSE.txt */
	...
	[179],
	{
		997: (e, t, n) => {
			...
			const s = {
				...
				'4ad92211': [
					() => n.e(9973).then(n.t.bind(n, 3769, 19)),
					'C:\\Users\\viski\\OneDrive\\Documents\\GitHub\\discord-bot\\urvo-docs\\.docusaurus\\docusaurus-plugin-content-docs\\default\\plugin-route-context-module-100.json',
					3769,
				],
				...
				c8ea7117: [() => n.e(1303).then(n.bind(n, 3800)), '@site/docs/commands/moderation/remove-timeout.md', 3800],
		...
		6931: (e, t, n) => {
										...
										Fe(
											n.map(function (e) {
												return $e(
													$e({}, e),
													{},
													{ algoliaSource: [].concat(Fe(e.algoliaSource || []), ['autocomplete-internal']) },
												);
											}),
										),
									);
				...
				var l = Re(i),
					...
					c = ve(function (e) {
						...
						if (t.isOpen) {
							...
							) || ((s.current = n), n.length > 0 && Qe({ onItemsChange: r, items: n, insights: l, state: t }));
						}
					}, 0);
				return {
					...
					subscribe: function (e) {
						var t = e.setContext,
							n = e.onSelect,
							r = e.onActive;
						i('addAlgoliaAgent', 'insights-plugin'),
							t({ algoliaInsightsPlugin: { __algoliaSearchParameters: { clickAnalytics: !0 }, insights: l } }),
							n(function (e) {
								var t = e.item,
									n = e.state,
									r = e.event,
					...
					return Et(
						...
						{},
						{
							requests: e.queries.map(function (n) {
								return {
									query: 'algolia' === e.requesterId ? Et(Et({}, n), {}, { params: Et(Et({}, r), n.params) }) : n,
									sourceId: t,
			...
			function At(e, t) {
				...
				return {
					then: function (t, r) {
						return At(e.then(jt(t, n, e), jt(r, n, e)), n);
					},
					catch: function (t) {
						return At(e.catch(jt(t, n, e)), n);
					},
					finally: function (t) {
						return (
			...
			function Lt(e) {
				return At(e, { isCanceled: !1, onCancelList: [] });
			}
			function jt(e, t, n) {
				return e
					? function (n) {
			...
			(Nt.resolve = function (e) {
				return Lt(Promise.resolve(e));
			}),
				(Nt.reject = function (e) {
					return Lt(Promise.reject(e));
				});
			var Ut = ['event', 'nextState', 'props', 'query', 'refresh', 'store'];
			function Mt(e, t) {
				var n = Object.keys(e);
				if (Object.getOwnPropertySymbols) {
					var r = Object.getOwnPropertySymbols(e);
			...
			function Vt(e) {
				var t = e.event,
					...
					l = e.store,
					s = zt(e, Ut);
				Gt && o.environment.clearTimeout(Gt);
				...
				if ((d(a), f(o.defaultActiveItemId), !a && !1 === o.openOnFocus)) {
					var m,
						h = l.getState().collections.map(function (e) {
							return Ft(Ft({}, e), {}, { items: [] });
						});
					p('idle'), c(h), u(null !== (m = r.isOpen) && void 0 !== m ? m : o.shouldPanelOpen({ state: l.getState() }));
					var g = Lt(
						Qt(h).then(function () {
				...
				p('loading'),
					(Gt = o.environment.setTimeout(function () {
						p('stalled');
					}, o.stallThreshold));
				var v = Lt(
					Qt(
						o.getSources(Ft({ query: a, refresh: i, state: l.getState() }, s)).then(function (e) {
							return Promise.all(
								e.map(function (e) {
									return Promise.resolve(e.getItems(Ft({ query: a, refresh: i, state: l.getState() }, s))).then(
										function (t) {
											return Ct(t, e.sourceId, l.getState());
										},
									);
								}),
							)
								...
								.then(function (e) {
									return (function (e) {
										...
										return Xe(n.reshape({ sourcesBySourceId: a, sources: Object.values(a), state: r }))
											.filter(Boolean)
											.map(function (e) {
					...
					.then(function (e) {
						...
						if (null !== l.getState().activeItemId && f) {
							var m = f.item,
								...
								v = f.source;
							v.onActive(
								Ft({ event: t, item: m, itemInputValue: h, itemUrl: g, refresh: i, source: v, state: l.getState() }, s),
							);
						}
					})
					.finally(function () {
						p('idle'), Gt && o.environment.clearTimeout(Gt);
					});
			...
			var Wt = ['event', 'props', 'refresh', 'store'];
			function Kt(e, t) {
				var n = Object.keys(e);
				if (Object.getOwnPropertySymbols) {
					var r = Object.getOwnPropertySymbols(e);
			...
			var en = /((gt|sm)-|galaxy nexus)|samsung[- ]|samsungbrowser/i;
			function tn(e) {
				return (
					(tn =
						'function' == typeof Symbol && 'symbol' == typeof Symbol.iterator
			...
			var nn = ['props', 'refresh', 'store'],
				rn = ['inputElement', 'formElement', 'panelElement'],
				on = ['inputElement'],
				an = ['inputElement', 'maxLength'],
				ln = ['sourceIndex'],
				sn = ['sourceIndex'],
				cn = ['item', 'source', 'sourceIndex'];
			function un(e, t) {
				var n = Object.keys(e);
				if (Object.getOwnPropertySymbols) {
					var r = Object.getOwnPropertySymbols(e);
				...
				return {
						...
						return dn(
							{
								...
								onSubmit: function (a) {
									var i;
									a.preventDefault(),
										t.onSubmit(dn({ event: a, refresh: n, state: r.getState() }, o)),
								...
								onReset: function (a) {
									var i;
									a.preventDefault(),
										t.onReset(dn({ event: a, refresh: n, state: r.getState() }, o)),
					...
					getLabelProps: function (e) {
						var n = e || {},
							r = n.sourceIndex,
							o = pn(n, ln);
						return dn({ htmlFor: ''.concat(a(t.id, r), '-input'), id: ''.concat(a(t.id, r), '-label') }, o);
					},
						...
						return dn(
							{
								...
								type: 'search',
								onChange: function (e) {
									Vt(dn({ event: e, props: t, query: e.currentTarget.value.slice(0, c), refresh: n, store: r }, o));
								},
								onKeyDown: function (e) {
										...
										if ('ArrowUp' === t.key || 'ArrowDown' === t.key) {
											var i = function () {
													var e = n.environment.document.getElementById(
														''.concat(n.id, '-item-').concat(o.getState().activeItemId),
													);
											...
											t.preventDefault(),
												!1 === o.getState().isOpen && (n.openOnFocus || Boolean(o.getState().query))
													? Vt(Yt({ event: t, props: n, query: o.getState().query, refresh: r, store: o }, a)).then(
															function () {
											...
											if (t.metaKey || t.ctrlKey)
												...
												Vt(
													Yt({ event: t, nextState: { isOpen: !1 }, props: n, query: u, refresh: r, store: o }, a),
												).then(function () {
													f.onSelect(
														Yt(
															{
									...
									})(dn({ event: e, props: t, refresh: n, store: r }, o));
								},
								onFocus: i,
								onBlur: ke,
								onClick: function (n) {
					...
					getListProps: function (e) {
						...
						return dn(
							{
								role: 'listbox',
								'aria-labelledby': ''.concat(a(t.id, r), '-label'),
								id: ''.concat(a(t.id, r), '-list'),
							},
							o,
						);
					},
					getItemProps: function (e) {
						...
						return dn(
							{
								id: ''.concat(a(t.id, s), '-item-').concat(i.__autocomplete_id),
								role: 'option',
								...
								onClick: function (e) {
									var a = l.getItemInputValue({ item: i, state: r.getState() }),
										s = l.getItemUrl({ item: i, state: r.getState() });
									(s
										? Promise.resolve()
										: Vt(dn({ event: e, nextState: { isOpen: !1 }, props: t, query: a, refresh: n, store: r }, o))
									).then(function () {
										l.onSelect(
											dn(
												{
			...
			var hn = '1.9.4',
				gn = [{ segment: 'autocomplete-core', version: hn }];
			function vn(e) {
				return (
					(vn =
						'function' == typeof Symbol && 'symbol' == typeof Symbol.iterator
			...
			function kn(e) {
				...
				return {
					...
					options: bn({ 'autocomplete-core': Object.keys(i) }, s),
					ua: gn.concat((null === (o = i.__autocomplete_metadata) || void 0 === o ? void 0 : o.userAgents) || []),
				};
			}
			function Sn(e) {
				var t,
				...
				return !1 === n.isOpen || null === n.activeItemId
					? null
					: (null === (t = Rt(n)) || void 0 === t ? void 0 : t.itemInputValue) || null;
			}
			function En(e, t, n, r) {
				if (!n) return null;
			...
			var Cn = function (e, t) {
				switch (t.type) {
					...
					case 'mousemove':
						return On(On({}, e), {}, { activeItemId: t.payload });
					case 'setQuery':
						return On(On({}, e), {}, { query: t.payload, completion: null });
					case 'setCollections':
						return On(On({}, e), {}, { collections: t.payload });
					case 'setIsOpen':
						return On(On({}, e), {}, { isOpen: t.payload });
					case 'setStatus':
						return On(On({}, e), {}, { status: t.payload });
					case 'setContext':
						return On(On({}, e), {}, { context: On(On({}, e.context), t.payload) });
					case 'ArrowDown':
						var n = On(
							On({}, e),
							{},
							{
								activeItemId: t.payload.hasOwnProperty('nextActiveItemId')
									...
									: En(1, e.activeItemId, rt(e), t.props.defaultActiveItemId),
							},
						);
						return On(On({}, n), {}, { completion: Sn({ state: n }) });
					case 'ArrowUp':
						var r = On(On({}, e), {}, { activeItemId: En(-1, e.activeItemId, rt(e), t.props.defaultActiveItemId) });
						return On(On({}, r), {}, { completion: Sn({ state: r }) });
					case 'Escape':
						return e.isOpen
							? On(On({}, e), {}, { activeItemId: null, isOpen: !1, completion: null })
							: On(On({}, e), {}, { activeItemId: null, query: '', status: 'idle', collections: [] });
					case 'submit':
						return On(On({}, e), {}, { activeItemId: null, isOpen: !1, status: 'idle' });
					case 'reset':
						return On(
							On({}, e),
							{},
					...
					case 'blur':
						return t.props.debug ? e : On(On({}, e), {}, { isOpen: !1, activeItemId: null });
					case 'mouseleave':
						return On(On({}, e), {}, { activeItemId: t.props.defaultActiveItemId });
					default:
			...
			function Ln(e) {
				var t = [],
					n = gt(e, t),
					r = Ye(Cn, n, function (e) {
						var t = e.prevState,
							r = e.state;
						n.onStateChange(An({ prevState: t, state: r, refresh: i, navigator: n.navigator }, o));
					}),
					o = (function (e) {
						var t = e.store;
						return {
										...
										return tt(
											...
											{},
											{
												items: Xe(e.items).map(function (e) {
													return tt(tt({}, e), {}, { __autocomplete_id: n++ });
												}),
											},
										);
									});
					...
					a = mn(An({ props: n, refresh: i, store: r, navigator: n.navigator }, o));
				function i() {
					return Vt(
						An(
							{
				...
				if (
					...
					var l = 'boolean' == typeof e.insights ? {} : e.insights;
					n.plugins.push(Ve(l));
				}
				return (
					...
					})({ metadata: kn({ plugins: n.plugins, options: e }), environment: n.environment }),
					An(An({ refresh: i, navigator: n.navigator }, a), o)
				);
			}
			...
			var Un = function (e) {
				...
				Bn = ['ontouchstart', 'ontouchend', 'ontouchmove', 'ontouchcancel'];
			function zn(e, t, n) {
			...
			function qn(e, t, n) {
				...
				if ('style' === t)
					...
					else for (t in n) (a && n[t] === a[t]) || zn(e.style, t, n[t]);
				else
					'o' === t[0] && 'n' === t[1]
						? ((r = t !== (t = t.replace(/Capture$/, ''))),
						  ((o = t.toLowerCase()) in e || Bn.includes(o)) && (t = o),
						  (t = t.slice(2)),
						  e._listeners || (e._listeners = {}),
						  (e._listeners[t] = n),
						  n ? a || e.addEventListener(t, $n, r) : e.removeEventListener(t, $n, r))
						: 'list' !== t &&
						    'tagName' !== t &&
						    'form' !== t &&
						    'type' !== t &&
			...
			function Gn(e, t) {
				for (var n in t) qn(e, Hn(n), t[n]);
			}
			function Qn(e, t) {
				for (var n in t) ('o' === n[0] && 'n' === n[1]) || qn(e, Hn(n), t[n]);
			}
			var Vn = ['children'];
			function Zn(e) {
				return (
			...
			function Yn(e) {
				return function (t, n) {
					...
					return Gn(i, a), i.append.apply(i, Zn(o)), i;
				};
			}
			function Xn(e) {
				return (
			...
			var or = function (e) {
				var t = e.autocompleteScopeApi,
					...
					l = rr(e, Jn),
					s = Yn(n)('input', l),
					c = r(tr({ state: i, props: o({ inputElement: s }), inputElement: s }, t));
				return (
					Gn(
						s,
						tr(
			...
			var cr,
				...
				gr = {},
				vr = [],
				yr = /acit|ex(?:s|g|n|p|$)|rph|grid|ows|mnc|ntw|ine[ch]|zoo|^ord|itera/i,
				br = Array.isArray;
			function wr(e, t) {
			...
			function Sr(e, t, n) {
				...
				if (
					(arguments.length > 2 && (i.children = arguments.length > 3 ? cr.call(arguments, 2) : n),
			...
			function Er(e, t, n, r, o) {
				...
				return null == o && null != ur.vnode && ur.vnode(a), a;
			}
			function _r(e) {
				return e.children;
			}
			...
			function Or(e, t) {
				if (null == t) return e.__ ? Or(e.__, e.__.__k.indexOf(e) + 1) : null;
				for (var n; t < e.__k.length; t++) if (null != (n = e.__k[t]) && null != n.__e) return n.__e;
				return 'function' == typeof e.type ? Or(e) : null;
			}
			function Pr(e) {
				var t, n;
			...
			function Cr(e) {
				((!e.__d && (e.__d = !0) && fr.push(e) && !Tr.__r++) || pr !== ur.debounceRendering) &&
					((pr = ur.debounceRendering) || mr)(Tr);
			}
			function Tr() {
				var e, t, n, r, o, a, i, l;
				for (fr.sort(hr); (e = fr.shift()); )
					e.__d &&
						((t = fr.length),
						(r = void 0),
						(o = void 0),
						...
						(l = n.__P) &&
							...
							Fr(r, a),
							a.__e != i && Pr(a)),
						fr.length > t && fr.sort(hr));
				Tr.__r = 0;
			}
			function Ir(e, t, n, r, o, a, i, l, s, c) {
				var u,
					d,
					f,
					p,
				...
				for (n.__k = [], u = 0; u < t.length; u++)
					if (
						null !=
						(p = n.__k[u] =
							null == (p = t[u]) || 'boolean' == typeof p || 'function' == typeof p
								? null
								: 'string' == typeof p || 'number' == typeof p || 'bigint' == typeof p
								  ? Er(null, p, null, null, p)
								  : br(p)
								    ? Er(_r, { children: p }, null, null, null)
								    : p.__b > 0
								      ? Er(p.type, p.props, p.key, p.ref ? p.ref : null, p.__v)
								      : p)
					) {
						if (((p.__ = n), (p.__b = n.__b + 1), null === (f = v[u]) || (f && p.key == f.key && p.type === f.type)))
							v[u] = void 0;
						else
							for (d = 0; d < y; d++) {
						...
						Mr(e, p, (f = f || gr), o, a, i, l, s, c),
							(m = p.__e),
							(d = p.ref) && f.ref != d && (g || (g = []), f.ref && g.push(f.ref, null, p), g.push(d, p.__c || m, p)),
							null != m
								? (null == h && (h = m),
								...
								: s && f.__e == s && s.parentNode != e && (s = Or(f));
					}
				for (n.__e = h, u = y; u--; )
					null != v[u] &&
						('function' == typeof n.type && null != v[u].__e && v[u].__e == n.__d && (n.__d = Lr(r).nextSibling),
						$r(v[u], v[u]));
				if (g) for (u = 0; u < g.length; u++) zr(g[u], g[++u], g[++u]);
			}
			function Ar(e, t, n) {
				for (var r, o = e.__k, a = 0; o && a < o.length; a++)
					(r = o[a]) && ((r.__ = e), (t = 'function' == typeof r.type ? Ar(r, t, n) : Nr(n, r, r, o, r.__e, t)));
				return t;
			}
			function Nr(e, t, n, r, o, a) {
				...
				if (void 0 !== t.__d) (i = t.__d), (t.__d = void 0);
					...
					e: if (null == a || a.parentNode !== e) e.appendChild(o), (i = null);
						...
						for (l = a, s = 0; (l = l.nextSibling) && s < r.length; s += 1) if (l == o) break e;
			...
			function Lr(e) {
				...
				if (e.__k) for (t = e.__k.length - 1; t >= 0; t--) if ((n = e.__k[t]) && (r = Lr(n))) return r;
				return null;
			}
			function jr(e, t, n) {
				'-' === t[0]
					? e.setProperty(t, null == n ? '' : n)
					: (e[t] = null == n ? '' : 'number' != typeof n || yr.test(t) ? n : n + 'px');
			}
				...
				e: if ('style' === t)
					if ('string' == typeof n) e.style.cssText = n;
						...
						if (('string' == typeof r && (e.style.cssText = r = ''), r))
							for (t in r) (n && t in n) || jr(e.style, t, '');
						if (n) for (t in n) (r && n[t] === r[t]) || jr(e.style, t, n[t]);
					}
				else if ('o' === t[0] && 'n' === t[1])
					(a = t !== (t = t.replace(/Capture$/, ''))),
						...
						e.l || (e.l = {}),
						(e.l[t + a] = n),
						n ? r || e.addEventListener(t, a ? Ur : Dr, a) : e.removeEventListener(t, a ? Ur : Dr, a);
			...
			function Dr(e) {
				return this.l[e.type + !1](ur.event ? ur.event(e) : e);
			}
			function Ur(e) {
				return this.l[e.type + !0](ur.event ? ur.event(e) : e);
			}
			function Mr(e, t, n, r, o, a, i, l, s) {
				...
				null != n.__h && ((s = n.__h), (l = t.__e = n.__e), (t.__h = null), (a = [l])), (c = ur.__b) && c(t);
				try {
					e: if ('function' == typeof _) {
						if (
							...
							n.__c
								...
								: ('prototype' in _ && _.prototype.render
										? (t.__c = u = new _(g, y))
										: ((t.__c = u = new xr(g, y)), (u.constructor = _), (u.render = qr)),
								  v && v.sub(u),
								  (u.props = g),
								  u.state || (u.state = {}),
								  (u.context = y),
							...
							null != _.getDerivedStateFromProps &&
								(u.__s == u.state && (u.__s = wr({}, u.__s)), wr(u.__s, _.getDerivedStateFromProps(g, u.__s))),
							(f = u.props),
							(p = u.state),
							(u.__v = t),
							d)
							...
							if (
								...
								(!u.__e && null != u.shouldComponentUpdate && !1 === u.shouldComponentUpdate(g, u.__s, y)) ||
									t.__v === n.__v)
							) {
								for (
						...
						if (
							...
							for (
								u.state = u.__s, u.__d = !1, w && w(t), c = u.render(u.props, u.state, u.context), S = 0;
								S < u._sb.length;
								S++
							)
								u.__h.push(u._sb[S]);
						...
						(u.state = u.__s),
							null != u.getChildContext && (r = wr(wr({}, r), u.getChildContext())),
							d || null == u.getSnapshotBeforeUpdate || (m = u.getSnapshotBeforeUpdate(f, p)),
							Ir(
								e,
								br((E = null != c && c.type === _r && null == c.key ? c.props.children : c)) ? E : [E],
								t,
								n,
								r,
								o,
						...
						null == a && t.__v === n.__v
							...
							: (t.__e = Br(n.__e, t, n, r, o, a, i, s));
					(c = ur.diffed) && c(t);
				} catch (e) {
					(t.__v = null), (s || null != a) && ((t.__e = l), (t.__h = !!s), (a[a.indexOf(l)] = null)), ur.__e(e, t, n);
				}
			}
			function Fr(e, t) {
				ur.__c && ur.__c(t, e),
			...
			function Br(e, t, n, r, o, a, i, l) {
				...
				if (('svg' === p && (o = !0), null != a))
					for (; m < a.length; m++)
						if ((s = a[m]) && 'setAttribute' in s == !!p && (p ? s.localName === p : 3 === s.nodeType)) {
							(e = s), (a[m] = null);
							break;
						}
				if (null == e) {
				...
				if (null === p) d === f || (l && e.data === f) || (e.data = f);
				else {
					if (
						((a = a && cr.call(e.childNodes)),
						(c = (d = n.props || gr).dangerouslySetInnerHTML),
					...
					if (
						((function (e, t, n, r, o) {
							var a;
							for (a in n) 'children' === a || 'key' === a || a in t || Rr(e, a, null, n[a], r);
							for (a in t)
						...
						for (m = a.length; m--; ) null != a[m] && kr(a[m]);
					l ||
						('value' in f &&
							void 0 !== (m = f.value) &&
							(m !== e.value || ('progress' === p && !m) || ('option' === p && m !== d.value)) &&
							Rr(e, 'value', m, d.value, !1),
						'checked' in f && void 0 !== (m = f.checked) && m !== e.checked && Rr(e, 'checked', m, d.checked, !1));
				}
				return e;
			}
			function zr(e, t, n) {
			...
			function $r(e, t, n) {
				var r, o;
				if (
					(ur.unmount && ur.unmount(e),
					(r = e.ref) && ((r.current && r.current !== e.__e) || zr(r, null, t)),
					null != (r = e.__c))
				) {
				...
				if ((r = e.__k)) for (o = 0; o < r.length; o++) r[o] && $r(r[o], t, n || 'function' != typeof e.type);
				n || null == e.__e || kr(e.__e), (e.__ = e.__e = e.__d = void 0);
			}
			function qr(e, t, n) {
			...
			function Hr(e, t, n) {
				...
				ur.__ && ur.__(e, t),
					...
					Mr(
						t,
						(e = ((!r && n) || t).__k = Sr(_r, null, [e])),
						o || gr,
						gr,
						void 0 !== t.ownerSVGElement,
						!r && n ? [n] : o ? null : t.firstChild ? cr.call(t.childNodes) : null,
						a,
			...
			(cr = vr.slice),
				...
				(xr.prototype.setState = function (e, t) {
					var n;
					(n = null != this.__s && this.__s !== this.state ? this.__s : (this.__s = wr({}, this.state))),
						'function' == typeof e && (e = e(wr({}, n), this.props)),
						e && wr(n, e),
						null != e && this.__v && (t && this._sb.push(t), Cr(this));
				}),
				(xr.prototype.forceUpdate = function (e) {
					this.__v && ((this.__e = !0), e && this.__h.push(e), Cr(this));
				}),
				(xr.prototype.render = _r),
				(fr = []),
				(mr = 'function' == typeof Promise ? Promise.prototype.then.bind(Promise.resolve()) : setTimeout),
				(hr = function (e, t) {
					return e.__v.__b - t.__v.__b;
				}),
				(Tr.__r = 0);
			var Qr = '__aa-highlight__',
				Vr = '__/aa-highlight__';
			function Zr(e) {
				var t = e.highlightedValue.split(Qr),
					n = t.shift(),
					r = (function () {
			...
			function Yr(e) {
				var t = e.hit,
					...
					o = Gr(t, ['_highlightResult'].concat(Wr(r), ['value']));
				return 'string' != typeof o && (o = Gr(t, r) || ''), Zr({ highlightedValue: o });
			}
			function Xr(e) {
				...
				function r(e) {
					...
					return t(
						n,
						{},
						Yr({ hit: r, attribute: o }).map(function (e, n) {
			...
			function so(e) {
				return e.some(function (e) {
					...
					? e.map(function (t, n) {
							return io(io({}, t), {}, { isHighlighted: !ro(e, n) });
					  })
					: e.map(function (e) {
							return io(io({}, e), {}, { isHighlighted: !1 });
					  });
			}
			function co(e) {
				var t = e.createElement,
				...
				function r(e) {
					...
					return t(
						n,
						{},
						((r = { hit: o, attribute: a }), so(Yr(r))).map(function (e, n) {
			...
			function po(e) {
				var t = e.hit,
					n = e.attribute,
					r = Array.isArray(n) ? n : [n],
					o = Gr(t, ['_snippetResult'].concat(uo(r), ['value']));
				return 'string' != typeof o && (o = Gr(t, r) || ''), Zr({ highlightedValue: o });
			}
			function mo(e) {
				var t = e.createElement,
				...
				function r(e) {
					...
					return t(
						n,
						{},
						((r = { hit: o, attribute: a }), so(po(r))).map(function (e, n) {
							return e.isHighlighted ? t(l, { key: n }, e.value) : e.value;
						}),
					);
				}
			...
			function ho(e) {
				...
				function r(e) {
					...
					return t(
						n,
						{},
						po({ hit: r, attribute: o }).map(function (e, n) {
							return e.isHighlighted ? t(i, { key: n }, e.value) : e.value;
						}),
					);
				}
			...
			var _o = {
				...
				Oo = { createElement: Sr, Fragment: _r, render: Hr };
			function Po(e) {
			...
			var Lo = [{ segment: 'autocomplete-js', version: hn }];
			function jo(e) {
				return (
					(function (e) {
			...
			var Uo = function (e) {
				return e && 'object' === Do(e) && '[object Object]' === Object.prototype.toString.call(e);
			};
			function Mo() {
				for (var e = arguments.length, t = new Array(e), n = 0; n < e; n++) t[n] = arguments[n];
				return t.reduce(function (e, t) {
			...
			function Yo(e) {
				var t,
					...
					f = l(function () {
						return (function (e) {
							...
							S.tagName;
							var E = ko(ko({}, Oo), g),
								_ = { Highlight: Xr(E), ReverseHighlight: co(E), ReverseSnippet: mo(E), Snippet: ho(E) };
							return {
								renderer: {
									classNames: vo(_o, null != n ? n : {}),
									container: S,
									getEnvironmentProps:
										null != o
											? o
									...
									panelContainer: f ? go(k, f) : k.document.body,
								...
								core: ko(ko({}, w), {}, { id: null !== (t = w.id) && void 0 !== t ? t : at(), environment: k }),
							};
						})(u.current);
					}),
					p = l(function () {
						...
						return Ln(
							Wo(
								...
								{},
								{
									...
									__autocomplete_metadata: { userAgents: Lo, options: e },
								},
							),
						);
					}),
					...
					y = l(function () {
						return Dn.bind(f.value.renderer.renderer.createElement);
					}),
					b = l(function () {
						return (function (e) {
							var t = e.autocomplete,
								...
								d = e.translations,
								f = Yn(o),
								p = s.getRootProps(lr({ state: u, props: t.getRootProps({}) }, n)),
								m = f('div', lr({ class: r.root }, p)),
								h = f('div', {
								...
								v = s.getLabelProps(lr({ state: u, props: t.getLabelProps({}) }, n)),
								y = f('button', {
									class: r.submitButton,
									type: 'submit',
									title: d.submitButtonTitle,
									children: [Un({ environment: o })],
								}),
								b = f('label', lr({ class: r.label, children: [y] }, v)),
								w = f('button', {
									class: r.clearButton,
									type: 'reset',
								...
								k = f('div', { class: r.loadingIndicator, children: [Fn({ environment: o })] }),
								S = or({
									class: r.input,
									environment: o,
									state: u,
								...
								O = s.getFormProps(lr({ state: u, props: t.getFormProps({ inputElement: S }) }, n)),
								P = f('form', lr({ class: r.form, children: [E, x, _] }, O)),
								C = s.getPanelProps(lr({ state: u, props: t.getPanelProps({}) }, n)),
								T = f('div', lr({ class: r.panel }, C)),
							...
							if (a) {
								var N = f('div', { class: r.detachedSearchButtonIcon, children: [Un({ environment: o })] }),
									L = f('button', {
										type: 'button',
				...
				function k(e) {
					...
					var t = {
						...
						n = (!rt(e) && !c.current && f.value.renderer.renderNoResults) || f.value.renderer.render;
					!(function (e) {
						var t = e.autocomplete,
							n = e.autocompleteScopeApi,
							r = e.dom,
							o = e.propGetters,
							a = e.state;
						Qn(r.root, o.getRootProps(Ao({ state: a, props: t.getRootProps({}) }, n))),
							Qn(
								r.input,
								o.getInputProps(
									Ao({ state: a, props: t.getInputProps({ inputElement: r.input }), inputElement: r.input }, n),
								),
							),
							Gn(r.label, { hidden: 'stalled' === a.status }),
							Gn(r.loadingIndicator, { hidden: 'stalled' !== a.status }),
							Gn(r.clearButton, { hidden: !a.query }),
							Gn(r.detachedSearchButtonQuery, { textContent: a.query }),
							Gn(r.detachedSearchButtonPlaceholder, { hidden: Boolean(a.query) });
					})(t),
						(function (e, t) {
							...
							if (c.isOpen) {
											...
											return d.createElement(
												...
												i.templates.noResults && 0 === l.length
													...
													: d.createElement(
															...
															To(
																{ className: o.list },
																s.getListProps(Ao({ state: c, props: n.getListProps({ sourceIndex: t }) }, r)),
															),
															l.map(function (e) {
																var l = n.getItemProps({ item: e, source: i, sourceIndex: t });
																return d.createElement(
																	'li',
																	To({ key: l.id, className: o.item }, s.getItemProps(Ao({ state: c, props: l }, r))),
																	i.templates.item({
																		components: u,
																		createElement: d.createElement,
																		Fragment: d.Fragment,
								...
								e(
									Ao(Ao({ children: p, state: c, sections: f, elements: m }, d), {}, { components: u, html: a }, r),
									i.panel,
								);
							...
							components:
								...
								Object.entries(t).reduce(function (e, t) {
									var r = qo(t, 2),
										o = r[0],
										a = r[1];
									return n({ key: o, value: a }) ? zo(zo({}, e), {}, $o({}, o, a)) : e;
								}, {})),
			...
			const sa = () => {
					...
					const {
						...
						} = (0, se.Z)(),
						{
							...
							maxSearchResults: f,
						} = (0, oa.eZ)('@cmfcmf/docusaurus-search-local'),
						p = (0, s.k6)(),
						{ tags: m } = (0, aa._q)(),
						h = (0, r.useRef)(m);
					(0, r.useEffect)(() => {
									...
									const n = await (async function (e, t) {
										{
											...
											return { documents: r.documents, index: ea.Index.load(r.index) };
										}
									})(o, e);
					...
					return (
											...
											return [
												{
													...
													async getItems() {
														const e = h.current,
															...
															r = ((e) => Jo.tokenizer(e).map((e) => e.str))(t);
														return n
															.flatMap((e) => {
																...
																return t
																	.query((e) => {
																		e.term(r, { fields: ['title'], boost: a }),
																			e.term(r, { fields: ['title'], boost: a, wildcard: ea.Query.wildcard.TRAILING }),
																			e.term(r, { fields: ['content'], boost: i }),
																			e.term(r, {
																				fields: ['content'],
																				boost: i,
																				wildcard: ea.Query.wildcard.TRAILING,
																			}),
																			e.term(r, { fields: ['tags'], boost: l }),
																			e.term(r, { fields: ['tags'], boost: l, wildcard: ea.Query.wildcard.TRAILING }),
																			d &&
						...
						r.createElement(
							r.Fragment,
							null,
							r.createElement(Xo.Z, null, r.createElement('body', { 'data-theme': t ? 'dark' : 'light' })),
				...
				ca = { searchBox: 'searchBox_ZlJk' };
			function ua(e) {
				let { children: t, className: n } = e;
				return r.createElement('div', { className: (0, o.Z)(n, ca.searchBox) }, t);
			}
			var da = n(868),
				fa = n(3734);
			var pa = n(6409);
			const ma = (e) => e.docs.find((t) => t.id === e.mainDocId);
			const ha = {
					default: ae,
					...
					search: function (e) {
						...
						return t ? null : r.createElement(ua, { className: n }, r.createElement(sa, null));
					},
					dropdown: fe,
					html: function (e) {
					...
					docsVersionDropdown: function (e) {
						...
						const { search: d, hash: f } = (0, s.TH)(),
							p = (0, da.Iw)(n),
							m = (0, da.gB)(n),
							{ savePreferredVersionName: h } = (0, pa.J)(n),
							g = m.map((e) => {
								const t = p.alternateDocVersions[e.name] ?? ma(e);
								return {
									label: e.label,
									to: `${t.path}${d}${f}`,
							...
							b =
								t && v.length > 1
									...
									: y.label,
							w = t && v.length > 1 ? void 0 : ma(y).path;
						return v.length <= 1
			...
			function ya() {
				...
				return r.createElement(
					...
					t.map((t, n) => r.createElement(va, (0, l.Z)({ mobile: !0 }, t, { onClick: () => e.toggle(), key: n }))),
				);
			}
			function ba(e) {
				return r.createElement(
			...
			function wa() {
				const e = 0 === (0, w.L)().navbar.items.length,
					t = D();
				return r.createElement(r.Fragment, null, !e && r.createElement(ba, { onClick: () => t.hide() }), t.content);
			}
			function ka() {
				const e = (0, T.e)();
				var t;
				return (
					...
					e.shouldRender
						? r.createElement(U, {
								...
								primaryMenu: r.createElement(ya, null),
								secondaryMenu: r.createElement(wa, null),
						  })
						: null
				);
			}
			const Sa = { navbarHideable: 'navbarHideable_m1mJ', navbarHidden: 'navbarHidden_jGov' };
			function Ea(e) {
				return r.createElement(
					'div',
			...
			function _a(e) {
				...
				return r.createElement(
					'nav',
					{
						...
						className: (0, o.Z)('navbar', 'navbar--fixed-top', n && [Sa.navbarHideable, !s && Sa.navbarHidden], {
							'navbar--dark': 'dark' === a,
					...
					t,
					r.createElement(Ea, { onClick: i.toggle }),
					r.createElement(ka, null),
				);
			}
			var xa = n(3905);
			const Oa = { errorBoundaryError: 'errorBoundaryError_a6uf' };
			function Pa(e) {
				return r.createElement(
					'button',
					(0, l.Z)({ type: 'button' }, e),
			...
			function Ca(e) {
				let { error: t } = e;
				const n = (0, xa.getErrorCausalChain)(t)
					.map((e) => e.message)
					.join('\n\nCause:\n');
				return r.createElement('p', { className: Oa.errorBoundaryError }, n);
			}
			...
			function Da() {
				...
				return r.createElement(Ra, {
					left: r.createElement(
						r.Fragment,
						null,
						!e.disabled && r.createElement(Na, null),
						r.createElement(Z, null),
						r.createElement(ja, { items: n }),
					),
					right: r.createElement(
						r.Fragment,
						null,
						r.createElement(ja, { items: o }),
						r.createElement(Q, { className: La.colorModeToggle }),
						!a && r.createElement(ua, null, r.createElement(sa, null)),
					),
				});
			}
			function Ua() {
				return r.createElement(_a, null, r.createElement(Da, null));
			}
			function Ma(e) {
				let { item: t } = e;
			...
			function Fa(e) {
				...
				return t.html
					...
					: r.createElement('li', { key: t.href ?? t.to, className: 'footer__item' }, r.createElement(Ma, { item: t }));
			}
			function Ba(e) {
				let { column: t } = e;
				return r.createElement(
					...
					r.createElement(
						...
						t.items.map((e, t) => r.createElement(Fa, { key: t, item: e })),
					),
				);
			}
			function za(e) {
				...
				return r.createElement(
					...
					t.map((e, t) => r.createElement(Ba, { key: t, column: e })),
				);
			}
			function $a() {
					...
					r.createElement(
						...
						t.map((e, n) =>
							r.createElement(
								r.Fragment,
								{ key: n },
								r.createElement(qa, { item: e }),
								t.length !== n + 1 && r.createElement($a, null),
							),
						),
					),
				);
			...
			function Ga(e) {
				...
				return (function (e) {
					...
					? r.createElement(za, { columns: t })
					: r.createElement(Ha, { links: t });
			}
			var Qa = n(7909);
			const Va = { footerLogoLink: 'footerLogoLink_BH7S' };
			function Za(e) {
				let { logo: t } = e;
				const { withBaseUrl: n } = (0, X.C)(),
					a = { light: n(t.src), dark: n(t.srcDark ?? t.src) };
				return r.createElement(Qa.Z, {
			...
			function Wa(e) {
				...
				return t.href
					? r.createElement(
							Y.Z,
							{ href: t.href, className: Va.footerLogoLink, target: t.target },
							r.createElement(Za, { logo: t }),
					  )
					: r.createElement(Za, { logo: t });
			}
			function Ka(e) {
			...
			function Xa() {
				...
				return r.createElement(Ya, {
					style: a,
					links: n && n.length > 0 && r.createElement(Ga, { links: n }),
					logo: o && r.createElement(Wa, { logo: o }),
					copyright: t && r.createElement(Ka, { copyright: t }),
				});
			}
			const Ja = r.memo(Xa),
				ei = (0, A.Qc)([
			...
			function ti(e) {
				let { children: t } = e;
				return r.createElement(ei, null, t);
			}
			function ni(e) {
				let { error: t, tryAgain: n } = e;
				return r.createElement(
					...
					r.createElement(
						...
						r.createElement(
							...
							r.createElement(
								...
								r.createElement(Pa, { onClick: n, className: 'button button--primary shadow--lw' }),
							),
							r.createElement('hr', null),
							r.createElement('div', { className: 'margin-vert--md' }, r.createElement(Ca, { error: t })),
						),
					),
				);
			}
			const ri = { mainWrapper: 'mainWrapper_z2l0' };
			function oi(e) {
				...
				return (
					...
					r.createElement(
						...
						r.createElement(
							'div',
							{ id: d, className: (0, o.Z)(g.k.wrapper.main, ri.mainWrapper, l) },
							r.createElement(a.Z, { fallback: (e) => r.createElement(ni, e) }, t),
						),
						!n && r.createElement(Ja, null),
					)
				);
			}
		},
			...
			const r = {
				...
				presets: [
					[
						'classic',
						{
							docs: {
								routeBasePath: '/',
								sidebarPath: 'C:\\Users\\viski\\OneDrive\\Documents\\GitHub\\discord-bot\\urvo-docs\\sidebars.js',
							},
							blog: !1,
							theme: {
								customCss:
									'C:\\Users\\viski\\OneDrive\\Documents\\GitHub\\discord-bot\\urvo-docs\\src\\css\\custom.css',
							},
						},
					],
				],
				themeConfig: {
					navbar: {
						hideOnScroll: !0,
						title: 'Urvo',
						items: [{ type: 'docSidebar', sidebarId: 'docs', position: 'left', label: 'Home' }],
					},
						...
						links: [
							...
							},
							{
								...
								items: [
									...
									{ label: 'GitHub Repository', href: 'https://github.com/vikiru/Urvo' },
								],
							},
						],
						copyright: 'Copyright \xa9 2023 Urvo, Visakan Kirubakaran. Built with Docusaurus.',
					},
					prism: {
						theme: {
