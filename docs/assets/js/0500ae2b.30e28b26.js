		...
		1096: (e, a, t) => {
			...
			const i = { id: 'category-overview', title: 'Category Overview' },
				...
				u = [
					...
					{ value: '\u2753 Information', id: 'info', level: 3 },
					{ value: '\ud83d\ude02 Memes', id: 'memes', level: 3 },
					{ value: '\ud83d\udd79\ufe0f Minigames', id: 'minigames', level: 3 },
					{ value: '\ud83d\udee1\ufe0f Moderation', id: 'moderation', level: 3 },
					{ value: '\ud83c\udfb2 Random', id: 'random', level: 3 },
					{ value: '\u2694\ufe0f Troopica', id: 'troopica', level: 3 },
					{ value: '\ud83d\udee0\ufe0f Utility', id: 'utility', level: 3 },
				],
				p = { toc: u },
				d = 'wrapper';
			function s(e) {
				...
				return (0, n.kt)(
					...
					(0, n.kt)(
						...
						(0, n.kt)(
							'li',
							{ parentName: 'ul' },
							(0, n.kt)('a', { parentName: 'li', href: 'category-overview#minigames' }, '\ud83d\udd79\ufe0f Minigames'),
						),
						(0, n.kt)(
							'li',
							{ parentName: 'ul' },
							(0, n.kt)(
								'a',
								{ parentName: 'li', href: 'category-overview#moderation' },
								'\ud83d\udee1\ufe0f Moderation',
							),
						),
						(0, n.kt)(
						...
						(0, n.kt)(
							'li',
							{ parentName: 'ul' },
							(0, n.kt)('a', { parentName: 'li', href: 'category-overview#troopica' }, '\u2694\ufe0f Troopica'),
						),
						(0, n.kt)(
							'li',
							{ parentName: 'ul' },
							(0, n.kt)('a', { parentName: 'li', href: 'category-overview#utility' }, '\ud83d\udee0\ufe0f Utility'),
						),
					),
					...
					(0, n.kt)('h3', { id: 'minigames' }, '\ud83d\udd79\ufe0f Minigames'),
					...
					(0, n.kt)('h3', { id: 'moderation' }, '\ud83d\udee1\ufe0f Moderation'),
					...
					(0, n.kt)('h3', { id: 'troopica' }, '\u2694\ufe0f Troopica'),
					...
					(0, n.kt)('h3', { id: 'utility' }, '\ud83d\udee0\ufe0f Utility'),
