...
(self.webpackChunkurvo_docs = self.webpackChunkurvo_docs || []).push([
	[6462],
	{
			...
			var c = n.createContext({}),
				...
				m = n.forwardRef(function (e, t) {
					var r = e.components,
						...
						u = s(r),
						m = o,
						f = u[''.concat(c, '.').concat(m)] || u[m] || d[m] || a;
					return r
		...
		7438: (e, t, r) => {
			...
			var n = r(7462),
				o = (r(7294), r(4137));
			const a = { id: 'acknowledgments', title: 'Acknowledgment' },
				i = void 0,
				l = {
					unversionedId: 'acknowledgments',
					id: 'acknowledgments',
					...
					permalink: '/Urvo/acknowledgments',
					draft: !1,
					tags: [],
					version: 'current',
					frontMatter: { id: 'acknowledgments', title: 'Acknowledgment' },
					sidebar: 'docs',
				...
				c = {},
				s = [{ value: '\u2728 Acknowledgments', id: '-acknowledgments', level: 2 }],
				p = { toc: s },
				u = 'wrapper';
			function d(e) {
