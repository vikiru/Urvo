...
(self.webpackChunkurvo_docs = self.webpackChunkurvo_docs || []).push([
	[1175],
	{
		...
		4545: (e, t, r) => {
			...
			var n = r(7462),
				o = (r(7294), r(4137));
			const a = { id: 'dog', title: 'Dog' },
				i = void 0,
				c = {
					unversionedId: 'commands/images/dog',
					id: 'commands/images/dog',
					title: 'Dog',
					description: 'Overview',
					source: '@site/docs/commands/images/dog.md',
					sourceDirName: 'commands/images',
					slug: '/commands/images/dog',
					permalink: '/Urvo/commands/images/dog',
					draft: !1,
					tags: [],
					version: 'current',
					frontMatter: { id: 'dog', title: 'Dog' },
					sidebar: 'docs',
					previous: { title: 'Coffee', permalink: '/Urvo/commands/images/coffee' },
					next: { title: 'Duck', permalink: '/Urvo/commands/images/duck' },
				},
				l = {},
				m = [
			...
			function p(e) {
				...
				return (0, o.kt)(
					...
					(0, o.kt)('p', null, 'Send a random image and fact of a dog into the server via an embed.'),
					...
					(0, o.kt)(
						'p',
						null,
						(0, o.kt)('img', { alt: 'Dog Command Demo GIF', src: r(3241).Z, width: '1220', height: '904' }),
					),
				);
			}
			p.isMDXComponent = !0;
		...
		3241: (e, t, r) => {
			r.d(t, { Z: () => n });
			const n = r.p + 'assets/images/dog-f45efb925ebb220abcbbb2703c661fcf.gif';
		},
	},
]);
