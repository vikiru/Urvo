...
(self.webpackChunkurvo_docs = self.webpackChunkurvo_docs || []).push([
	[9514, 4248],
	{
		1299: (e, t, n) => {
			...
			function N(e) {
				...
				return a.createElement(
					'button',
					{
						...
						className: (0, o.Z)('button button--secondary button--outline', I.collapseSidebarButton),
						onClick: t,
					},
			...
			function H(e) {
				let { item: t, onItemClick: n, activePath: l, level: c, index: s, ...d } = e;
				const { items: m, label: u, collapsible: b, className: p, href: h } = t,
					...
					v = (0, i._F)(t, l),
					g = (0, L.Mg)(h, l),
					{ collapsed: _, setCollapsed: S } = (0, w.u)({ initialState: () => !!b && !v && t.collapsed }),
				...
				return (
					...
					})({ isActive: v, collapsed: _, updateCollapsed: T }),
					(0, a.useEffect)(() => {
						b && null != I && I !== s && E && S(!0);
					}, [b, I, s, S, E]),
					a.createElement(
						...
						a.createElement(
							'div',
							{ className: (0, o.Z)('menu__list-item-collapsible', { 'menu__list-item-collapsible--active': g }) },
							a.createElement(
								A.Z,
								(0, C.Z)(
									{
						...
						a.createElement(
							...
							a.createElement(j, { items: m, tabIndex: _ ? -1 : 0, onItemClick: n, activePath: l, level: c + 1 }),
						),
					)
				);
			}
			...
			function R(e) {
				...
				return a.createElement(
					'li',
					{
						className: (0, o.Z)(r.k.docs.docSidebarItemLink, r.k.docs.docSidebarItemLinkLevel(c), 'menu__list-item', b),
						key: u,
					},
					a.createElement(
						A.Z,
						(0, C.Z)(
							{
								className: (0, o.Z)('menu__link', !E && D.menuExternalLink, { 'menu__link--active': h }),
								autoAddBaseUrl: p,
			...
			function U(e) {
				...
				switch (t.type) {
					...
					case 'html':
						return a.createElement(z, (0, C.Z)({ item: t }, n));
					default:
			...
			const j = (0, a.memo)(K),
				q = { menu: 'menu_SIkG', menuWithAnnouncementBar: 'menuWithAnnouncementBar_GW3s' };
			function G(e) {
				let { path: t, sidebar: n, className: l } = e;
				const c = (function () {
				...
				return a.createElement(
					'nav',
					{
						...
						className: (0, o.Z)('menu thin-scrollbar', q.menu, c && q.menuWithAnnouncementBar, l),
					},
					a.createElement(
						'ul',
						{ className: (0, o.Z)(r.k.docs.docSidebarMenu, 'menu__list') },
			...
			const Y = 'sidebar_njMd',
				...
				J = 'sidebarLogo_isFc';
			function Q(e) {
				let { path: t, sidebar: n, onCollapse: l, isHidden: r } = e;
				const {
				...
				return a.createElement(
					'div',
					{ className: (0, o.Z)(Y, c && O, r && X) },
					c && a.createElement(_.Z, { tabIndex: -1, className: J }),
					a.createElement(G, { path: t, sidebar: n }),
					i && a.createElement(N, { onClick: l }),
				);
			}
			const $ = a.memo(Q);
			var ee = n(3086),
			...
			const ne = (e) => {
				...
				return a.createElement(
					...
					a.createElement(j, {
						...
						activePath: n,
						onItemClick: (e) => {
							'category' === e.type && e.href && l.toggle(), 'link' === e.type && l.toggle();
						},
						level: 1,
					}),
				);
			...
			function le(e) {
				const t = (0, g.i)(),
					n = 'desktop' === t || 'ssr' === t,
					o = 'mobile' === t;
				return a.createElement(a.Fragment, null, n && a.createElement($, e), o && a.createElement(oe, e));
			}
			const re = { expandButton: 'expandButton_m80_', expandButtonIcon: 'expandButtonIcon_BlDH' };
			function ce(e) {
			...
			function de(e) {
				...
				return a.createElement(
					'aside',
					{
						...
						onTransitionEnd: (e) => {
							e.currentTarget.classList.contains(ie.docSidebarContainer) && n && s(!0);
						},
					},
					a.createElement(
						se,
						...
						a.createElement(
							'div',
							{ className: (0, o.Z)(ie.sidebarViewport, i && ie.sidebarViewportHidden) },
			...
			function ue(e) {
				...
				return a.createElement(
					'main',
					{ className: (0, o.Z)(me.docMainContainer, (t || !l) && me.docMainContainerEnhanced) },
					a.createElement(
						'div',
						{
							className: (0, o.Z)(
			...
			const be = { docPage: 'docPage__5DB', docsWrapper: 'docsWrapper_BCFX' };
			function pe(e) {
				let { children: t } = e;
				const n = (0, d.V)(),
					[o, l] = (0, a.useState)(!1);
				return a.createElement(
					...
					a.createElement(
						...
						n && a.createElement(de, { sidebar: n.items, hiddenSidebarContainer: o, setHiddenSidebarContainer: l }),
						a.createElement(ue, { hiddenSidebarContainer: o }, t),
					),
				);
			}
			var he = n(4248),
			...
			function fe(e) {
				...
				return a.createElement(
					a.Fragment,
					null,
					a.createElement(Ee.Z, { version: t.version, tag: (0, c.os)(t.pluginId, t.version) }),
					a.createElement(
						l.d,
						null,
				...
				return a.createElement(
					...
					a.createElement(
						...
						a.createElement(
							s.q,
							{ version: t },
							a.createElement(d.b, { name: m, items: u }, a.createElement(pe, null, c)),
						),
					),
				);
			}
