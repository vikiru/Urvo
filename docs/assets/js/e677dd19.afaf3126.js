...
(self.webpackChunkurvo_docs = self.webpackChunkurvo_docs || []).push([
	[6019],
	{
		4137: (e, t, r) => {
			...
			function f(e, t) {
				...
				if ('string' == typeof e || a) {
					...
					(m.originalType = e), (m[u] = 'string' == typeof e ? e : a), (i[1] = m);
		...
		4368: (e, t, r) => {
			...
			var n = r(7462),
				a = (r(7294), r(4137));
			const o = { id: 'buzz', title: 'Buzz Lightyear Meme' },
				i = void 0,
				m = {
					unversionedId: 'commands/memes/buzz',
					id: 'commands/memes/buzz',
					title: 'Buzz Lightyear Meme',
					description: 'Overview',
					source: '@site/docs/commands/memes/buzz.md',
					sourceDirName: 'commands/memes',
					slug: '/commands/memes/buzz',
					permalink: '/Urvo/commands/memes/buzz',
					draft: !1,
					tags: [],
					version: 'current',
					frontMatter: { id: 'buzz', title: 'Buzz Lightyear Meme' },
					sidebar: 'docs',
					previous: { title: 'Urban', permalink: '/Urvo/commands/info/urban' },
					next: { title: 'Change My Mind Meme', permalink: '/Urvo/commands/memes/change-my-mind' },
				},
				l = {},
				c = [
			...
			function d(e) {
				...
				return (0, a.kt)(
					...
					(0, a.kt)('p', null, 'Send a Buzz Lightyear Everywhere meme with your desired text.'),
					(0, a.kt)(
						'table',
						null,
						(0, a.kt)(
						...
						(0, a.kt)(
							...
							(0, a.kt)(
								...
								(0, a.kt)(
									'td',
									{ parentName: 'tr', align: 'center' },
									(0, a.kt)('inlineCode', { parentName: 'td' }, 'format'),
								),
								(0, a.kt)('td', { parentName: 'tr', align: 'center' }, 'The format of the meme (PNG or GIF)'),
							),
						),
					),
					...
					(0, a.kt)(
						...
						null,
						(0, a.kt)('img', {
							alt: 'Buzz Lightyear Meme Command Demo Gif',
							src: r(9124).Z,
							width: '1220',
							height: '954',
						}),
		...
		9124: (e, t, r) => {
			r.d(t, { Z: () => n });
			const n = r.p + 'assets/images/buzz-671a9a3c2b2db47fab9ad058f916a454.gif';
		},
	},
]);
