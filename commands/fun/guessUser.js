...
module.exports = {
    ...
    async execute(interaction) {
        ...
        const userEmbed = new EmbedBuilder()
            ...
            .setColor('#b35843')
            .setTimestamp()
            .addFields({ name: 'Age', value: ageResult.age.toString() }, { name: 'Gender', value: properCase(genderResult.gender) }, { name: 'Nationality', value: nationality.country[0].country_id.toString() }, )
