...
module.exports = {
    data: new SlashCommandBuilder()
        ...
        .addNumberOption((option) => option.setName('duration').setDescription('How long the user should be timed out').setRequired(true))
        .addStringOption((option) => option.setName('units').setDescription('Specify what unit of time the duration of the timeout is').setRequired(true).addChoices({ name: 'Minutes', value: 'minutes' }, { name: 'Hours', value: 'hours' }, { name: 'Days', value: 'days' }))
